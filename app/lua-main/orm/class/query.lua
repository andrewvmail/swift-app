    ...
    local query = {
        ...
        _add = function (self)
            ...
            if needPrimaryKey then
                local result,rowId = lua_thread.postToThreadSync(self.own_table.cacheThreadId,"lua-main.orm.cache","insert",self.own_table.__tablename__,kv,needPrimaryKey)
                self:setPrimaryKey(needPrimaryKey,rowId)
                return rowId
            else
                lua_thread.postToThread(self.own_table.cacheThreadId,"lua-main.orm.cache","insert",self.own_table.__tablename__,kv,needPrimaryKey)
        ...
        delete = function (self)
            ...
            lua_thread.postToThreadSync(self.own_table.cacheThreadId,"lua-main.orm.cache","deleteWithPrimaryKey",self.own_table.__tablename__,{self[self.own_table.__primary_key.name]})
            self._data = {}
        end
    }
...
local QueryList = require('lua-main.orm.class.query_list')
