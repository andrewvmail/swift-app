...
--                               Require                                    --
------------------------------------------------------------------------------
require ("lua-main.orm.class.global")
require ("lua-main.orm.tools.func")
------------------------------------------------------------------------------
--                          Required classes                                --
------------------------------------------------------------------------------

local Select = require('lua-main.orm.class.select')
local Query, QueryList = require('lua-main.orm.class.query')
local fields = require('lua-main.orm.tools.fields')
...
function  Table:isTableExist(tableName)
    ...
    local result = lua_thread.postToThreadSync(self.cacheThreadId,"lua-main.orm.cache","query",sql,{tableName})
...
function Table:existColumnsForTable(tableName)
    ...
    local result = lua_thread.postToThreadSync(self.cacheThreadId,"lua-main.orm.cache","query",sql,{},"name")
    return result
end
...
function Table:updateTableSchema(table_instance)
    ...
    for i,colType in ipairs(table_instance.__colnames) do
        if not table.has_value(existColumns, colType.name) then
            ...
            lua_thread.postToThreadSync(self.cacheThreadId,"lua-main.orm.cache","execute",sql)
        end
    end
end
...
function Table:createIndex(table_instance,colType)
    ...
    return lua_thread.postToThreadSync(self.cacheThreadId,"lua-main.orm.cache","execute",sql)
end
...
function Table:create_table(table_instance)
    ...
    lua_thread.postToThreadSync(self.cacheThreadId,"lua-main.orm.cache","execute",create_query)
end
...
function Table.addTableInfo(params,callback)
    ...
    lua_thread.postToThread(threadId,"lua-main.orm.class.table","addTableInfoOnLogicThread",params, c);
end
...
function Table.addTableInfoOnLogicThread(params,callback)
    ...
    lua_thread.postToThreadSync(threadId,"lua-main.orm.dbData","setDBParams",tableName, info)
    Table(tableName)
    callback();
end
...
function Table.saveOrm(params,callback)
    ...
    local threadId = lua_thread.createThread(BusinessThreadLOGIC,"OrmsThread")
    lua_thread.postToThread(threadId,"lua-main.orm.class.table","saveOrmOnLogicThread",params, c);
end
...
function Table.batchSaveOrms(params,callback)
    ...
    -- local list = require('lua-main.orm.class.query_list')(t,data)
    ...
    -- print("time 1 ".. require("socket").gettime())
    lua_thread.postToThread(t.cacheThreadId,"lua-main.orm.cache","batchInsert",t.__tablename__,params)
...
function Table.getAllByParams(params,callback)
    ...
    local threadId = lua_thread.createThread(BusinessThreadLOGIC,"OrmsThread")
    lua_thread.postToThread(threadId,"lua-main.orm.class.table","getAllByParamsOnLogicThread",params, c);
end
...
function Table.getFirstByParams(params,callback)
    ...
    local threadId = lua_thread.createThread(BusinessThreadLOGIC,"OrmsThread")
    lua_thread.postToThread(threadId,"lua-main.orm.class.table","getFirstOnLogicThread",params, c);
end
...
function Table.deleteByParams(params,callback)
    ...
    local threadId = lua_thread.createThread(BusinessThreadLOGIC,"OrmsThread")
    lua_thread.postToThread(threadId,"lua-main.orm.class.table","deleteByParamsOnLogicThread",params, c);
...
function Table.updateByParams(params,callback)
    ...
    local threadId = lua_thread.createThread(BusinessThreadLOGIC,"OrmsThread")
    lua_thread.postToThread(threadId,"lua-main.orm.class.table","updateByParamsOnLogicThread",params, c);
...
function Table.new(self, tableName)
    ...
    local args = argsCache[tableName] or lua_thread.postToThreadSync(self.DBDataThreadId,"lua-main.orm.dbData","tableParams",tableName)
    ...
    lua_thread.synchronized(function ()
        ...
        local dbInfo = lua_thread.postToThreadSync(self.DBDataThreadId,"lua-main.orm.dbData","get",self.__dbname__)
        if  not dbInfo then
            ...
            lua_thread.postToThreadSync(self.DBDataThreadId,"lua-main.orm.dbData","set", self.__dbname__,dbInfo)
        end 
        lua_thread.postToThreadSync(dbInfo.threadId,"lua-main.orm.cache","initWithDB",self.__dbname__)
